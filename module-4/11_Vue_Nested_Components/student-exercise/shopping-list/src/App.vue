<template>
  <div id="app">
    ...
    <shopping-list title="Groceries" v-bind:items="groceries" v-bind:search="filter" ></shopping-list>
    <shopping-list title="Costco" v-bind:items="costco" v-bind:search="filter" ></shopping-list>
    <shopping-list title="Target" v-bind:items="target" v-bind:search="filter" ></shopping-list>
