...
public class NotificationController {
	...
	public String processNotificationSignups(@RequestParam String firstName, @RequestParam String lastName, @RequestParam String emailAddress, @RequestParam int age) {
	...
	public String showNotificiationSignupResult() {
