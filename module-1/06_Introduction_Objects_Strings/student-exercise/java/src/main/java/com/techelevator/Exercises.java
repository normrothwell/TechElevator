...
public class Exercises {
	...
	public String firstHalf(String str) {
		int halfLengthOfString = (str.length())/2;
		return(str.substring(0, halfLengthOfString));
	}
	...
	public String left2(String str) {
		String firstTwoOfString = str.substring(0,2);
		return (str.substring(2) + firstTwoOfString);
	}
	...
	public String right2(String str) {
		String lastTwoOfString = str.substring((str.length() - 2), (str.length()));
		return (lastTwoOfString + str.substring(0, (str.length()-2)));
	}
	...
	public String middleTwo(String str) {
		...
		return (str.substring((halfStringSize - 1), (halfStringSize + 1)));
	}
	...
	public String twoChar(String str, int index) {
		if ((index > str.length()) || (index < 1) || (index + 2 > str.length())){
			return (str.substring(0,2));
	...
	public boolean hasBad(String str) {
		if (str.length()<3) {
			return false;
		}else if (((str.length() == 3) || (str.length() == 4)) && ((str.substring(0, 3).equals("bad")) || (str.substring(1).equals("bad")))){
			return true;
	...
	public boolean doubleX(String str) {
		...
		if (findX == -1) {
			return false;
		}else if ((findX + 1)==str.length()) {
			return false;
		}else if (((findX+2)==str.length()) && (str.substring(findX).equals("xx"))) {
			return true;
		}else if (str.substring(findX, findX+2).equals("xx")) {
			return true;
		}return false;
	...
	public String stringSplosion(String str) {
		...
		for (int x=0;x<str.length();x++) {
			answer = answer + str.substring(0,x);
		}answer = answer + str;
		return answer;
	}
	...
	public int last2(String str) {
		...
		String finalTwo = "";
		if (str.length()>2) {
			finalTwo = str.substring(str.length() - 2);
		}
		for (int x=0;x<str.length()-2;x++) {
			if (str.substring(x,x+2).equals(finalTwo)) {
				answer++;
			}
		}
		return answer;
	...
	public String altPairs(String str) {
		String answer = "";
		for (int x=0;x<str.length();x=x+4) {
			answer = answer + (str.charAt(x));
				if (x+1<str.length()) {
						answer = answer + (str.charAt(x+1));
				}
		}return answer;
	}
